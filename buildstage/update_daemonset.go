...
func (r *BuildStage) MergeDaemonSetToSpec(daemonset *v1.DaemonSet) error {
	...
	daemonset.Spec.Template.Spec.Containers[r.Deploy.Spec.Deploy.HandleContainer].Image = r.Deploy.Spec.Publish.Host + "/" + r.Deploy.Spec.Publish.Tag + ":" + r.Deploy.Status.Built.Git.Commit
	return err
}
